-- LMS Pasraman — Preserve student scores on batch save
-- 2026-06-07: Remove score deletion from save_chapter_batch RPC.
-- Previously, ANY teacher save (even a typo fix) deleted ALL pretest/posttest scores.
-- Now scores are preserved. Teacher can use Reset Prototype for full data reset.
...
begin
  ...
  -- 5. Pretest — delete questions, keep scores
  ...
  -- 6. Posttest — delete questions, keep scores
  ...
  -- Reset chapter progress (mark as not done so students redo content)
